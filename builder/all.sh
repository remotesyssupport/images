...
sudo docker build -rm -t bradrydzewski/scala:2.10.3  builder/scala/scala_2.10.3/
sudo docker build -rm -t bradrydzewski/scala:2.9.3   builder/scala/scala_2.9.3/
...
sudo docker build -rm -t bradrydzewski/lein builder/clojure/lein/
